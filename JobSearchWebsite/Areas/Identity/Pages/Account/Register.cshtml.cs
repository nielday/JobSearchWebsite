...
namespace JobSearchWebsite.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            public string Role { get; set; } // Thêm trường Role
        }
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ApplicationUser { UserName = Input.Email, Email = Input.Email, RegisteredDate = DateTime.Now };
                ...
                if (result.Succeeded)
                {
                    ...
                    // Gán vai trò
                    if (Input.Role == "JobSeeker" || Input.Role == "Employer")
                    {
